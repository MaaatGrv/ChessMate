package src.controler.controlerLocal;

import src.controler.AbstractChessGameControler;
 ...
 * 
 *         Ce controleur local précise comment empêcher un joueur à qui ce n'est
 *         pas le tour
...
public class ChessGameControler extends AbstractChessGameControler {
	 ...
	 * la vue se servira de cette information pour empêcher tout déplacement sur le
	 * damier
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see controler.AbstractChessGameControler#endMove(model.Coord, model.Coord,
	 * java.lang.String)
	 * 

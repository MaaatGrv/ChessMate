...
public class CavalierTest {
    ...
    public void testDeplacement() {
        ...
        assertTrue("Cavalier noir devrait pouvoir se déplacer en (3, 1)", cavalierNoir.isMoveOk(3, 1, false, false));
        assertFalse("Cavalier noir ne devrait pas pouvoir se déplacer en (4, 4)",
                cavalierNoir.isMoveOk(4, 4, false, false));
        assertTrue("Cavalier noir devrait pouvoir se déplacer en (2, 2)", cavalierNoir.isMoveOk(2, 2, false, false));
        assertFalse("Cavalier noir ne devrait pas pouvoir se déplacer en (1, 0)",
                cavalierNoir.isMoveOk(1, 0, false, false));

        // Test de la méthode isMoveOk() pour le cavalier blanc
        assertTrue("Cavalier blanc devrait pouvoir se déplacer en (3, 1)", cavalierBlanc.isMoveOk(3, 1, false, false));
        assertFalse("Cavalier blanc ne devrait pas pouvoir se déplacer en (4, 4)",
                cavalierBlanc.isMoveOk(4, 4, false, false));
        assertTrue("Cavalier blanc devrait pouvoir se déplacer en (2, 2)", cavalierBlanc.isMoveOk(2, 2, false, false));
        assertFalse("Cavalier blanc ne devrait pas pouvoir se déplacer en (1, 0)",
                cavalierBlanc.isMoveOk(1, 0, false, false));
    }
}
